...
namespace TryFirstProj.Areas.Employees.Controllers
{
    ...
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,EmployeeName,EmployeePhone,EmployeeEmail,EmployeeAge,EmployeeSalary")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,EmployeeName,EmployeePhone,EmployeeEmail,EmployeeAge,EmployeeSalary")] Employee employee)
        {
